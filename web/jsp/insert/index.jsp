                ...
                <div class="col-md-4 col-md-offset-4 jumbotron">
                        ...
                        <form role="form" name="registration" action="insertplant" method="post">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="TPlantName" value="" />
                            </div>
                            <div class="form-group">
                                <label>Plant Owner:</label>
                                <input class="form-control" type="text" name="TPlantOwner" value="" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="pwd" class="form-control" name="password" value="" /> 
                            </div>
                            <div class="form-group">
                                <label>Confirm Password:</label> 
                                <input type="password" class="form-control" id="pwd2" name="cpassword" value="" /> <br>
                            </div>
